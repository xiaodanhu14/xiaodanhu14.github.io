...
declare module '$env/static/private' {
	...
	export const MVCAM_COMMON_RUNENV: string;
	export const MVCAM_GENICAM_CLPROTOCOL: string;
	export const MVCAM_GIGE_DEBUG_HEARTBEAT: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		MVCAM_COMMON_RUNENV: string;
		MVCAM_GENICAM_CLPROTOCOL: string;
		MVCAM_GIGE_DEBUG_HEARTBEAT: string;
		NODE: string;
		NODE_ENV: string;
		NODE_EXE: string;
		NPM_CLI_JS: string;
